...
public class FormKhachHang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_diemtichluy.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(txt_makh, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(jLabel2)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(txt_tenkh, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_diemtichluy, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(33, 33, 33)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (selectedRow != -1) {
            Integer maKh = (Integer) jTable1.getValueAt(selectedRow, 0);
            String tenKH = (String) jTable1.getValueAt(selectedRow, 1);
            String sdt = (String) jTable1.getValueAt(selectedRow, 2);
            String email = (String) jTable1.getValueAt(selectedRow, 3);
            Integer dtl = (Integer) jTable1.getValueAt(selectedRow, 4);

            // Gán giá trị vào các ô text
            txt_makh.setText(maKh.toString());
            txt_tenkh.setText(tenKH);
            txt_sdt.setText(sdt);
            txt_email.setText(email);
            txt_diemtichluy.setText(dtl.toString());
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txt_sdt.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập sdt!");
            return;
        }
        if(khachHangDao.add(new KhachHang(0, txt_tenkh.getText(), txt_sdt.getText(), txt_email.getText(), 0))){
            LoadData();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       if(khachHangDao.edit(new KhachHang(Integer.parseInt(txt_makh.getText()), txt_tenkh.getText(), txt_sdt.getText(), txt_email.getText(), Integer.parseInt(txt_diemtichluy.getText())))){
            LoadData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       if(khachHangDao.delete(new KhachHang(Integer.parseInt(txt_makh.getText()), txt_tenkh.getText(), txt_sdt.getText(), txt_email.getText(), Integer.parseInt(txt_diemtichluy.getText())))){
            LoadData();
